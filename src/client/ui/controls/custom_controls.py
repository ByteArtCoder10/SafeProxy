    ...
    def __init__(self, text: str):
        ...
        self.content = ft.Column(
            controls=[
                ...
                ft.Divider(color=ft.Colors.with_opacity(
                    0.3, ft.Colors.PRIMARY))
            ], spacing=5)
...
class CustomPopUpModal(ft.Container):
    def __init__(self, on_submit):
        ...
        self.title_text = ft.Text(
            value="Add New Blacklist Host/URL", size=24, weight="bold")
        self.input_field = CustomTextField(
            label_text="Enter Host/URL", field_width=400)
        ...
        self.content = ft.Container(
            ...
            content=ft.Column([
                ft.Row([
                    self.title_text,
                    ft.IconButton(ft.Icons.CLOSE, on_click=self.close,
