...
class AccountView:
    def __init__(self, page: ft.Page):
        ...
        delete_section = ft.Row(
            controls=[
                ft.Text(value="Danger Zone:", weight="bold",
                        size=18, color=ft.Colors.RED),
                ft.VerticalDivider(
                    color=ft.Colors.with_opacity(0.4, ft.Colors.RED)),
                CustomBtn(text="Delete Account", bg_color=ft.Colors.RED, width=200, height=40,
                          text_color=ft.Colors.WHITE, elevation=2, on_click=self._open_dialog)
