...
class Parser():
    ...
    def parse_request(request: str) -> Request:
        ...
        try:
            ...
            core_logger.debug(
                f"Host by first line: {host}, Host by headers: {host_header_value}")
            ...
            if uri_form == "origin-form" and not host_header_value:
                ...
                raise ValueError(
                    "Host header does not match request URI host/port.")
            ...
            parsed_request = Request(
                method, host, port, http_version, path, headers, body)
