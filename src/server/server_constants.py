...
CORE_CLIENTS_LOG_DIR_PATH = str(
    proj_path / "src" / "server" / "logs" / "output" / "clients")
CORE_MAIN_LOG_FILE_PATH = str(
    proj_path / "src" / "server" / "logs" / "output" / "core.log")
DB_MAIN_LOG_FILE_PATH = str(
    proj_path / "src" / "server" / "logs" / "output" / "DB.log")
...
FOLDERS_EXISTS_CHECK = [CA_CERT_AND_KEY_DIR,
                        CORE_CLIENTS_LOG_DIR_PATH, DB_DIR_PATH, CERTS_DIR, JWT_AUTH_KEYS_DIR]
